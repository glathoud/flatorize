/*
  ...
  Copyright 2015 Guillaume Lathoud
...
(function () {
   ...
   // var o = flatorize.getCodeD( { name: "functionname", switcher: switcherfun } );
    // }}}
    {
        ...
        var opt = {
            helper_decl_name : cfg.helper_decl_name  ||  null
        }
    ...
    // }}}
    {
        ...
        ,   ret  = {
            ...
            , helper_decl_dfltcode : helper_decl( opt )
        ...
        function helper_decl( /*?object?*/opt )
        {
            return helper_decl_code( fixed2, opt );
        }
    ...
    function helper_decl_code( /*object*/fixed, /*?object?*/opt )
    {
        var lines = [ 
            line_comment_code( '--- Code generated by helper_decl' + ( !opt  ?  '()'  :  '(opt: ' + JSON.stringify( opt  ||  null ) + ')' ) + ' ---' ) 
            , ''
        ]
    ...
    {
        var helper_decl_name = (opt  &&  opt.helper_decl_name)  ||  "helper_decl.d"
            ...
            lines = lines
                .concat(
                    [
                        ...
                        , 'import ' + helper_decl_name.replace (/\.d$/,'') + '; ' + line_comment_code( 'customizable, or customized, through `opt.helper_decl_name`' )
                        , ''
                        , ''
