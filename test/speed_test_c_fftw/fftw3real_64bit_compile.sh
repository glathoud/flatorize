...
set -v
export OUTDIR='fftw3real_64bit.outdir'
mkdir -p $OUTDIR
rm -f $OUTDIR/*
#
# Compiling
...
gcc -o $OUTDIR/fftw3real.bin          $OUTDIR/fftw3real_common.o fftw3real_64bit_main.c -lfftw3 -lm  -lrt
gcc -o $OUTDIR/fftw3real_measure.bin          $OUTDIR/fftw3real_common.o fftw3real_64bit_measure_main.c -lfftw3 -lm -lrt
#
# Testing
#
