...
fm_id
fm_inv_of_ij
fm_mul_inplace_of_ijk
fm_mu_sigma_of_dim
fm_xvmxv_of_dim

zz_fm_mul_inplace_of_ijk_abc
zz_fm_mul_of_ijk_ab
zz_fm_matmul
...
(function fm_unittest() {
    ...
    function fm_unittest_impl()
    {
        ...
        var flatmatmul_inplace_342 = fm_mul_inplace_of_ijk( 3, 4, 2 );
        ...
        ,   flatmatmul_inplace_4 = fm_mul_inplace_of_ijk( 4 )
        ;
...
function fm_mul_inplace_of_ijk( /*integer*/I, /*?integer?*/J, /*?integer?*/K )
...
// its values will be overwritten.
{
    ...
    ,   key = [ I, J, K ].join( '#' )
    ;
    if (!(key in fm_mul_inplace_of_ijk))
    {
        var func = FR(
            ...
            , zz_fm_mul_inplace_of_ijk_abc.bind( null, I, J, K )
            
        )
            .getDirect() // no FR wrapper, to get the fastest performance
        ;
        
        fm_mul_inplace_of_ijk[ key ] = func;
    }
    return fm_mul_inplace_of_ijk[ key ];
}
...
function zz_fm_mul_inplace_of_ijk_abc( /*integer*/I, /*integer*/J, /*integer*/K, a, b, c )
