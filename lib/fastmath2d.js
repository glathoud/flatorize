...
/*global FR fastmath2d Float64Array JSON setTimeout
...
zz_fm2d_flatmatmul_of_ijk_ab
zz_fm2d_matmul
zz_fm2d_flatmat_mu_sigma_of_dim
zz_fm2d_flatmat_xmV_M_xmV_of_dim_xVM
zz_fm2d_matmul_of_ijk_ab
...
(function fm2d_unittest() {
    ...
    function fm2d_unittest_impl()
    {
        ...
        var flatmatinv_4     = fm2d_flatmatinv_of_ij( 4 )
        ,   flatmatmul_inplace_4 = fm2d_flatmatmul_inplace_of_ijk( 4 )
        ;
        ...
        flatmatmul_inplace_4( M, Minv, tmp );
...
function fm2d_flatmatid( /*integer*/I, /*integer*/J )
{
...
function fm2d_flatmatinv_of_ij( /*integer*/I, /*?integer?*/J )
{
    J != null  ||  (J = I);  // default: square matrix
    ...
    ,    B_init = fm2d_flatmatid( I, J )

    ,    abs = Math.abs
    ;
    
    return fm2d_flatmatinv;

    function fm2d_flatmatinv
...
// both (Float64)Arrays of numbers.  Returned value : `{mu,sigma}`
{
    ...
    return fm2d_flatmat_mu_sigma_of_dim[ dim ];
}
...
function zz_fm2d_flatmat_mu_sigma_of_dim( dim )
