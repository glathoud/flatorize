...
function hand_mul_inplace_of_ijk( I, J, K )
{
    return hand_mul_inplace_of_abc;
    
    function hand_mul_inplace_of_abc( a, b, c )
    {
        var c_ind = c.length;
        for (var i = I; i--;)
        {
...
{
    var mul_left = hand_mul_inplace_of_ijk( 1, dim, dim )
...
(function fm_speedtest_unittest() {
    ...
    ;
    fm_mul_inplace_of_ijk( 3, 4, 2 )( a, b, c_fm );
    hand_mul_inplace_of_ijk( 3, 4, 2 )( a, b, c_hand );
